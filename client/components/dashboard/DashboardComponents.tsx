...
export function RouteTracker({ progress }: { progress: number }) {
  ...
  return <section className="route-tracker"><div className="route-visual"><svg className="route-energy-svg" viewBox="0 0 1202 194" preserveAspectRatio="none" aria-hidden="true"><defs><linearGradient id="route-energy-gradient" x1="0" x2="1"><stop offset="0" stopColor="#00BFFF" /><stop offset="1" stopColor="#00FFFF" /></linearGradient><filter id="route-energy-glow" x="-30%" y="-300%" width="160%" height="700%"><feGaussianBlur stdDeviation="7" result="blur" /><feMerge><feMergeNode in="blur" /><feMergeNode in="SourceGraphic" /></feMerge></filter></defs><path className="route-energy-base" d="M138 149.5 H1065" /><path className="route-energy-completed" d="M138 149.5 H1065" pathLength="100" style={{ strokeDasharray: `${boundedProgress} ${100 - boundedProgress}` }} /><path className="route-energy-flow route-energy-flow-one" d="M1065 149.5 H138" /><path className="route-energy-flow route-energy-flow-two" d="M1065 149.5 H138" /><path className="route-energy-pulse" d="M138 149.5 H1065" /><rect className="route-energy-segment" x="138" y="140" width="93.5" height="19" /><rect className="route-energy-segment" x="232" y="140" width="93.5" height="19" /><rect className="route-energy-segment" x="804" y="140" width="93.5" height="19" /><rect className="route-energy-segment" x="942" y="140" width="93.5" height="19" /><ellipse className="route-energy-shadow" cx="569" cy="150.5" rx="119" ry="6.5" /><path className="route-energy-platform" d="M377 140 H750 Q760 140 760 154 Q760 169 750 169 H377 Q367 169 367 154 Q367 140 377 140 Z" /><path className="route-energy-chevron route-energy-chevron-one" d="M321.5 136 l23 13 -23 13 M344.5 136 l23 13 -23 13" /><path className="route-energy-chevron route-energy-chevron-two" d="M758.5 136 l23 13 -23 13 M781.5 136 l23 13 -23 13" /><path className="route-energy-chevron route-energy-chevron-three" d="M895.5 136 l23 13 -23 13 M918.5 136 l23 13 -23 13" /></svg><div className="route-flag route-start"><img src={ROUTE_START_FLAG_IMAGE} alt="Start" /></div><div className="route-flag route-end"><img src={ROUTE_END_FLAG_IMAGE} alt="Destination" /></div><div className="route-vehicle-motion" style={{ left: `${8 + boundedProgress * 0.84}%` }}><img src={ROUTE_SUV_IMAGE} alt="Vehicle" /></div></div></section>;
}
